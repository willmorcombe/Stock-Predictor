          ...
          <section className="hompage-section">
            <div className="page-data">
              ...
              <h7 className="description info-item">
                ...
                predicting stock trends on purely historical data. Below are
                nine stocks that have been tracked and a model has been trained
                on each stock to predict their closing day price using a simple
                LSTM. The below figure is a percentage of correct prediction
                (meaning did the stock go up when it was predicted to, or did
                the stock go down when it was predicted to).
              </h7>
