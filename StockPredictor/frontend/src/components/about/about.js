            ...
            <div className="page-article">
              <div className="about-article-content">
                ...
                <h7 className="description">
                  ...
                  worth of historical data that is stored for training purposes.
                </h7>
              </div>
            </div>
            ...
            <div className="about-article-container">
              <div className="page-article">
                <div className="about-article-content">
                  ...
                  <h7 className="description">
                    ...
                    used is an{" "}
                    <b style={{ color: "var(--color-primary" }}>LSTM</b> trained
                    with tensorflow. The input only uses the{" "}
              ...
              <div className="page-article">
                <div className="about-article-content">
                  ...
                  <h7 className="description">
                    At the end of each (working) day, a comparison will be made
                    to see if the prediction was "correct". This basically means
                    that if the model predicted that the closing price would go
                    down that day, and this was also shown in the actual stock
                    closing value, then a{" "}
